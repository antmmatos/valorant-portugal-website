    ...
    return (
        <main className={styles.main}>
            <div className={styles.container}>
                ...
                <ol className={`${styles.regulamento} ${styles.regulamentoOl}`}>
                    <li
                    ...
                    >
                        ...
                        >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Jogos serão transmitido ou gravados por algum
                                observador da equipa VLRPT
                            </li>
                        </ol>
                    </li>
                    <li
                    ...
                    >
                        ...
                        >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Um jogador suplente pode ser adicionado antes ou
                                depois de um jogo/mapa completo.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Cada jogador só pode representar uma equipa no
                                mesmo Torneio.
                            </li>
                        </ol>
                    </li>
                    ...
                    >
                        ...
                        >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Todos os cheats estão estritamente proibidos em
                            ...
                            Hitbox manipulação
                            <br />
                            Teletransporte (qualquer tipo de transporte que não
                            seja disponível no jogo)
                            <br />
                            Uso de qualquer bug/bugs para ganhar vantagem contra
                            os seus oponentes.
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Caso seja constatado que um jogador está a usar
                                qualquer tipo de programas de auxilio externo,
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Ferramentas de sobreposição de terceiros não são
                                permitidas. Exemplos:
                            </li>
                            Overwolf (Trackers)
                            <br />
                    ...
                    >
                        ...
                        >
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                As pausas técnicas são apenas para dificuldades
                                técnicas ou desconexões durante o início da
                                ronda (fase de compra).
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Na eventualidade de um jogador se desconectar a
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                As pausas técnicas tem uma duração de 10 minutos
                                (máximos). Caso seja necessário um tempo extra
                                cabe ao observador da partida decidir se é
                                justificável ou não. Quando ambas as equipas
                                estiverem prontas para continuar devem usar o
                                chat in-game para informar o observador (nunca o
                                party voice chat). Usar a pausa técnica como
                                pausa tática é proíbido.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                No caso de Prorrogação, cada equipa irá ter o
                                direito de mais uma pausa tática para usar na
                                prorrogação.
                            </li>
                        </ol>
                    </li>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                de conteúdo não contam como jogadores
                                competidores, e por tal não podem fazer stream.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                É permitido realizar Watch party's do torneio
                                através de uma stream de um observador.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                ...
                                Torneio. Apenas parceiros de produção aprovados
                                e jogadores concorrentes poderão transmitir o
                                evento principal.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                ...
                                "mostrar corpos", de acordo com as diretrizes da
                                Riot.
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Para todos os indivíduos que desejam transmitir,
                                solicitamos educadamente o relatório de todas as
                                estatísticas após o evento.
                            </li>
                        </ol>
                    </li>
                    <li
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                「🏆」primeira-liga / 「🏆」segunda-liga ) de 8
                                equipas
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Confrontos no formato Round Robin (todos jogam
                                contra todos) com 1 volta
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                A despromoção e promoção de equipas da 1° para a
                                2° liga, e vice-versa, será feita através de uma
                                final four entre o 7° e 8° lugar da 1° liga e o
                                1° e 2° da 2° liga (double elimination bracket)
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                A qualificação para as ligas poderá ser feita
                                através de um qualificador realizado ao mesmo
                                tempo que as ligas (single elimination bracket)
                                no qual apenas as equipas campeã e vice-campeã
                                poderão aceder a uma final four contra o 7° e 8°
                                da 2° liga
                            </li>
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                A falta de comparência de 2 ou mais equipas das
                                ligas custará no uso dos resultados atuais (
                                caso não se tenha terminado a primeira volta) ou
                                os resultados da primeira volta (caso já tenha
                                sido concluída)
                            </li>
                        </ol>
                    </li>
                    ...
                    >
                        ...
                        >
                            ...
                            (o processo de veto poderá alterar face a um update
                            de mapas no Valorant ou restrição da Riot)
                            <br />
                            <br />
                            ...
                            <li
                                className={`${styles.regulamento} ${styles.regulamentoLi}`}
                            >
                                Novos agentes terão um período de experiência de
                                quatro (4) semanas. Se o torneio começar durante
                                este período de experiência, o agente será
                                proibido pelo resto do torneio.
                            </li>
                        </ol>
                    </li>
                    <li
                    ...
                    >
                        ...
                        >
                            ...
                            circunstâncias que possam estar fora das regras, a
                            decisão da Staff é final.
                        </ol>
                    </li>
                </ol>
            </div>
