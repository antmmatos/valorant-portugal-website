...
DELETE FROM `users`;
INSERT INTO `users` (`ID`, `Username`, `Password`, `Email`, `Role`, `DiscordData`, `RegisterDate`, `LastLoginDate`) VALUES
	(1, 'admin', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '123', 'user', '{"id":"892504906576048138","username":"srd4rkoficial","avatar":"a_792edbe072322e68d90f48e5f761cded"}', '2023-09-03 03:35:53', '2023-09-03 03:35:53');
